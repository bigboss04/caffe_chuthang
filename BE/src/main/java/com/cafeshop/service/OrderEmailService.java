...
public class OrderEmailService {
    ...
    public void sendOrderConfirmationToCustomer(Order order) {
        ...
        try {
            ...
            helper.setSubject("✅ Xác nhận đơn hàng #" + order.getOrderId() + " - Nông Sản Phú Yên");
                        ...
                        <body style="margin:0;padding:0;background:#f5f0e8;font-family:'Segoe UI',Arial,sans-serif;">
                            <div style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(44,24,16,0.1);margin-top:20px;margin-bottom:20px;">
                                ...
                                <div style="background:linear-gradient(135deg,#2C1810 0%%,#3D2B1F 100%%);padding:32px;text-align:center;">
                                    ...
                                    <p style="color:rgba(255,255,255,0.5);font-size:12px;margin:8px 0 0;text-transform:uppercase;letter-spacing:2px;">Nông Sản Phú Yên</p>
                                </div>
                                ...
                                <div style="background:#2C1810;padding:20px;text-align:center;">
                                    <p style="color:rgba(255,255,255,0.3);font-size:11px;margin:0;text-transform:uppercase;letter-spacing:2px;">Nông Sản Phú Yên — Phong vị cao nguyên</p>
                                </div>
                            </div>
                        </body>
                        </html>
                        ...
                        <body style="margin:0;padding:0;background:#f5f0e8;font-family:'Segoe UI',Arial,sans-serif;">
                            <div style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(44,24,16,0.1);margin-top:20px;margin-bottom:20px;">
                                ...
                                <div style="background:linear-gradient(135deg,#2C1810 0%%,#3D2B1F 100%%);padding:40px 32px;text-align:center;">
                                    ...
                                    <p style="color:#D4A373;font-size:14px;margin:12px 0 0;">Cảm ơn bạn đã tin chọn Nông Sản Phú Yên</p>
                                </div>
                                ...
                                <div style="padding:32px;">
                                    ...
                                    <div style="background:#FDF8F0;border-radius:12px;padding:16px 20px;text-align:right;">
                                        <span style="font-size:13px;color:#9E8B7A;">Tổng thanh toán: </span>
                                        <span style="font-size:20px;color:#D4A373;font-weight:700;">%s</span>
                                    </div>
